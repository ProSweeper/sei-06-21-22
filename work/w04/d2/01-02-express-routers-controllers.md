...
> **IMPORTANT KEY POINT:** The path specified in `app.use` is **prepended** to the paths specified in the router object forming the actual path of the defined route, thus the above paths are a "starts with path".
