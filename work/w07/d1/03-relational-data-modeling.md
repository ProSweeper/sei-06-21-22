...
- A **business** has one **mailing address** and vice-versa:
	...
	<img src="https://i.imgur.com/VWkbqxi.png" height="300">
...
- Usually by focusing on two entities, [domain knowledge](https://en.wikipedia.org/wiki/Domain_knowledge) and common-sense will reveal the relationship (usually a one-to-many or many-to-many)
