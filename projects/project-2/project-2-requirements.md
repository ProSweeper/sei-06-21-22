...
**You will be working individually for this project.** You'll be designing and coding the app yourself. However, you will have access to up to ten, fifteen minute one-on-one sessions with your instructors.

> Note: In this remote format, we no longer track the specific amount of support provided.
...
### Planning - Due by 4:15 PT Thursday, July 21st:
...
### Project Presentations - Friday, July 29th:
